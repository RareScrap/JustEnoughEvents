...
import ru.rarescrap.gloomyfolken.hooklib.asm.HookInjectorFactory.MethodEnter;
import ru.rarescrap.gloomyfolken.hooklib.asm.HookInjectorFactory.MethodExit;
...
public class AsmHook implements Cloneable, Comparable<AsmHook> {
    ...
    public class Builder extends AsmHook {
         ...
         * import static ru.rarescrap.gloomyfolken.hooklib.asm.TypeHelper.*
         * //...
